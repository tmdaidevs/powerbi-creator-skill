...
mcp.tool()(tools.full_modernization)
mcp.tool()(tools.inject_custom_theme)
mcp.tool()(tools.apply_conditional_format)
mcp.tool()(tools.remove_visual)
mcp.tool()(tools.remove_page)
mcp.tool()(tools.rename_visual)
mcp.tool()(tools.get_semantic_model_schema)
mcp.tool()(tools.suggest_visuals)
